...
local STRINGS = {
    ...
    -- OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Blendet die Warnung aus, die beim Öffnen des Bonuswürfel-Fensters erscheint.", -- ⚠️ UNVERIFIED (temporarily disabled)
    ...
    -- OPTIONS_DISABLE_BONUS_ROLL_WARN = "Bonuswürfel-Warnungen ausblenden", -- ⚠️ UNVERIFIED (temporarily disabled)
