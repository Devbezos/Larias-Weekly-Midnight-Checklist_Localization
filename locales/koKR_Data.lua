...
local DATASET = {

    {
        ...
        items = {
            { id = "f4b92a82", text = "레벨업할 각 캐릭터에 로그인하여 휴식 경험치 누적을 시작하게 하세요." }, -- ⚠️ UNVERIFIED: 휴식 경험치 (Rested XP)
            ...
            { id = "2687fe6c", text = "각 지역의 보물을 찾아 무료 영예 획득. 가이드는 문서 참조." }, -- ⚠️ UNVERIFIED: 각 지역의 보물 (Midnight regional treasures)
            { id = "91e7ee6c", text = "영예를 위해 4x 사냥감을 일반 난이도로 완료" },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "da2fa0ef", text = "줄아만에서 주간 풍요 이벤트 완료" },
            { id = "dbc8384b", text = "하란다르에서 주간 하라니르의 전설 이벤트 완료" },
            { id = "9ad64245", text = "공허폭풍에서 주간 Stormarion Assault 완료" },
            { id = "35bc0cfd", text = "(선택) 영예를 위해 모든 희귀몹을 한번씩 잡기. 희귀몹마다 주1회만 평판 지급" },
            { id = "d47e5b93", text = "아직 안 했다면, 각 지역의 보물을 찾아 무료 영예 획득. 가이드는 문서 참조." }, -- ⚠️ UNVERIFIED: 각 지역의 보물 (Midnight regional treasures)
