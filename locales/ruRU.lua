...
local STRINGS = {
    ...
    -- OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Скрывает предупреждение, отображаемое при открытии окна бонусных бросков.", -- ⚠️ UNVERIFIED (temporarily disabled)
    ...
    -- OPTIONS_DISABLE_BONUS_ROLL_WARN = "Скрыть предупреждения о бонусных бросках", -- ⚠️ UNVERIFIED (temporarily disabled)
