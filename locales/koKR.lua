...
local STRINGS = {
    ...
    -- OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "보너스 굴림 창이 열릴 때 표시되는 경고를 숨깁니다.", -- ⚠️ UNVERIFIED (temporarily disabled)
    ...
    -- OPTIONS_DISABLE_BONUS_ROLL_WARN = "보너스 굴림 경고 숨기기", -- ⚠️ UNVERIFIED (temporarily disabled)
