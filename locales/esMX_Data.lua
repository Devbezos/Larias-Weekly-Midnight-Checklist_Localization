...
local DATASET = {
    ...
    },
    {
        ...
        items = {
            ...
            { id = "35bc0cfd", text = "(Opcional) Mata cada élite raro una vez en cada zona para reputación. Tienen un bloqueo semanal por raro." },
            { id = "d47e5b93", text = "Si no hecho, busca los tesoros de cada región para reputación gratuita. Ver documento para la guía." }, -- ⚠️ UNVERIFIED: tesoros de región Midnight
    ...
    },
    {
        ...
        items = {
            ...
            { id = "26d0b610", text = "Haz al menos una Profundidad abundante T11 para conseguir la misión de Piedra rúnica agrietada" }, -- ⚠️ UNVERIFIED: Profundidad abundante (Bountiful Delve)
