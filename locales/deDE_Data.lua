...
local DATASET = {

    {
        ...
        items = {
            { id = "f4b92a82", text = "Mit jedem Charakter einloggen, den du leveln möchtest, damit er mit dem Ansammeln ausgeruhter EP beginnt." }, -- ⚠️ UNVERIFIED: ausgeruhte EP (Rested XP)
            ...
            { id = "2687fe6c", text = "Schätze jeder Region für kostenloses Ansehen aufspüren. Dokument für Guide lesen." }, -- ⚠️ UNVERIFIED: Midnight Regionsschätze
            { id = "91e7ee6c", text = "4x Beute auf Normaler Schwierigkeit für Ansehen abschließen." },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "35bc0cfd", text = "(Optional) Jeden seltenen Gegner einmal pro Zone für Ansehen töten. Wöchentlicher Lockout pro Seltenem." },
            { id = "d47e5b93", text = "Falls noch nicht erledigt, Schätze jeder Region für kostenloses Ansehen aufspüren. Dokument für Guide lesen." }, -- ⚠️ UNVERIFIED: Midnight Regionsschätze
    ...
    },
    {
        ...
        items = {
            ...
            { id = "26d0b610", text = "Mindestens eine T11-Üppige Tiefe für den Zerbrochener-Schlussstein-Quest machen" }, -- ⚠️ UNVERIFIED: Bountiful Delve term
