...
local STRINGS = {
    ...
    -- OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Oculta o aviso exibido quando a janela de rolagem de bônus é aberta.", -- ⚠️ UNVERIFIED (temporarily disabled)
    ...
    -- OPTIONS_DISABLE_BONUS_ROLL_WARN = "Ocultar Avisos de Rolagem de Bônus", -- ⚠️ UNVERIFIED (temporarily disabled)
