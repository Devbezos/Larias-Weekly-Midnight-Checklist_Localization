...
local DATASET = {

    {
        ...
        items = {
            { id = "f4b92a82", text = "Entre com cada personagem que planeja nivelar para que comecem a acumular EXP descansada." }, -- ⚠️ UNVERIFIED: EXP descansada (Rested XP)
            ...
            { id = "2687fe6c", text = "Procure os tesouros de cada região para renome gratuito. Veja o documento para o guia." }, -- ⚠️ UNVERIFIED: tesouros de cada região (Midnight regional treasures)
            { id = "91e7ee6c", text = "Complete a Presa 4 vezes na dificuldade normal para obter renome." },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "e326ed96", text = "Complete a Soirée de Saltheril semanal em Bosques da Canção Eterna." },
            ...
            { id = "35bc0cfd", text = "(Opcional) Mate cada raro uma vez em cada zona para renome. Cada raro tem bloqueio semanal." },
            { id = "d47e5b93", text = "Se ainda não feito, procure os tesouros de cada região para renome gratuito. Veja o documento para o guia." }, -- ⚠️ UNVERIFIED: tesouros de cada região (Midnight regional treasures)
    ...
    },
    {
        ...
        items = {
            ...
            { id = "26d0b610", text = "Faça pelo menos uma Imersão Abundante de nível 11 para obter a missão da Pedra-Rúnica Rachada" }, -- ⚠️ UNVERIFIED: Imersão Abundante (Bountiful Delve)
