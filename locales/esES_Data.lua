...
local DATASET = {

    {
        ...
        items = {
            { id = "f4b92a82", text = "Inicia sesión en cada personaje que planeas subir de nivel para que empiecen a acumular EXP de descanso." }, -- ⚠️ UNVERIFIED: EXP de descanso (Rested XP)
            ...
            { id = "complete_the_weekly_stormarion_assault_in_the_voidstorm_it_is_available_in_early_access", text = "Completa el Asalto de Stormarion semanal en la Tormenta del vacío. (Disponible en acceso anticipado)" }, -- ⚠️ UNVERIFIED
            { id = "35bc0cfd", text = "(Opcional) Mata cada élite raro una vez en cada zona para reputación. Tienen un bloqueo semanal por raro." },
            { id = "2687fe6c", text = "Busca los tesoros de cada región para reputación gratuita. Ver documento para la guía." }, -- ⚠️ UNVERIFIED: tesoros de región Midnight
            { id = "91e7ee6c", text = "Completa 4 veces la Presa en dificultad normal para reputación." },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "d47e5b93", text = "Si no se ha hecho, busca los tesoros de cada región para reputación gratuita. Ver documento para la guía." }, -- ⚠️ UNVERIFIED: tesoros de región Midnight
    ...
    },
    {
        ...
        items = {
            ...
            { id = "optional_complete_a_world_tour_of_m0_dungeons_rewards_champ_ilvl", text = "(¿Opcional?) Completa un tour mundial de mazmorras M0 – recompensa nivel de objeto campeón" }, -- ⚠️ UNVERIFIED
    ...
    },
    {
        ...
        items = {
            ...
            { id = "26d0b610", text = "Haz al menos una Profundidad abundante T11 para obtener la misión de la Piedra de Runas resquebrajada" }, -- ⚠️ UNVERIFIED: Profundidad abundante (Bountiful Delve)
