...
local STRINGS = {
    ...
    -- OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Nasconde l'avviso mostrato quando si apre la finestra del tiro bonus.", -- ⚠️ UNVERIFIED (temporarily disabled)
    ...
    -- OPTIONS_DISABLE_BONUS_ROLL_WARN = "Nascondi avvisi tiro bonus", -- ⚠️ UNVERIFIED (temporarily disabled)
