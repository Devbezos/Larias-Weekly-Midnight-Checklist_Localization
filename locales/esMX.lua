...
local STRINGS = {
    ...
    -- OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Oculta la advertencia que se muestra cuando se abre la ventana de tirada de bonificación.", -- ⚠️ UNVERIFIED (temporarily disabled)
    ...
    -- OPTIONS_DISABLE_BONUS_ROLL_WARN = "Ocultar advertencias de tirada de bonificación", -- ⚠️ UNVERIFIED (temporarily disabled)
