...
local DATASET = {

    {
        ...
        items = {
            { id = "f4b92a82", text = "Accedi a ogni personaggio che intendi livellare in modo che inizi ad accumulare EP di riposo." }, -- ⚠️ UNVERIFIED: EP di riposo (Rested XP)
            ...
            { id = "2687fe6c", text = "Cerca i tesori di ogni regione per reputazione gratuita. Vedi doc per la guida." }, -- ⚠️ UNVERIFIED: tesori di ogni regione (Midnight regional treasures)
            { id = "91e7ee6c", text = "Completa 4 volte la Preda in difficoltà normale per reputazione." },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "35bc0cfd", text = "(Facoltativo) Uccidi ogni raro una volta per zona per reputazione. Ogni raro ha un limite settimanale." },
            { id = "d47e5b93", text = "Se non ancora fatto, cerca i tesori di ogni regione per reputazione gratuita. Vedi doc per la guida." }, -- ⚠️ UNVERIFIED: tesori di ogni regione (Midnight regional treasures)
    ...
    },
    {
        ...
        items = {
            ...
            { id = "26d0b610", text = "Fai almeno una Scorribanda generosa di livello 11 per ottenere la missione della Pietra Runica Incrinata" }, -- ⚠️ UNVERIFIED: Scorribanda generosa (Bountiful Delve)
