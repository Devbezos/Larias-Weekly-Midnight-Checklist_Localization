...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "if_available_complete_the_weekly_saltheril_s_soiree_in_eversong_woods_with_the_dmf_buff", text = "Si disponible, completa la Velada de Saltheril semanal en los Bosques Siempreverd." },
            ...
            { id = "if_available_complete_the_weekly_stormarion_assault_in_the_voidstorm_with_the_dmf_buff", text = "Si disponible, completa el Asalto de Tormarión semanal en la Tormenta del Vacío." },
...
{ id = "raise_the_singularity_renown_to_rank_7_for_1_6_champion_trinket", text = "Sube la reputación de La Singularidad a rango 7 para abalorio de campeón 1/6" },
            ...
            { id = "complete_the_weekly_saltheril_s_soiree_in_eversong_woods_with_the_dmf_buff", text = "Completa la Velada de Saltheril semanal en los Bosques Siempreverd." },
            ...
            { id = "complete_the_weekly_stormarion_assault_in_the_voidstorm_with_the_dmf_buff", text = "Completa el Asalto de Tormarión semanal en la Tormenta del Vacío." },
            ...
            { id = "if_not_done_with_dmf_buff_hunt_down_each_region_s_treasures_for_free_renown_see_doc_for_guide", text = "Si no hecho, busca los tesoros de cada región para reputación gratuita. Ver documento para la guía." }, -- ⚠️ UNVERIFIED: tesoros de región Midnight
